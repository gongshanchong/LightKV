...
inline void drawLine(std::vector<int>& max,int columns) {  //画行线
...
inline void drawDatas(std::vector<int>& max, std::vector<std::vector<std::string>>& Str,
...
inline void maxLenForEveryCol(std::vector<std::vector<std::string>>& datas, std::vector<int>& maxLen, std::vector<std::string>& head) {
